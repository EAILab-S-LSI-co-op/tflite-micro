...
bazel-bin/tensorflow/lite/micro/examples/fmnist/quantization/ptq\
   --source_model_dir=/workspace/tflm/tflite-micro/tensorflow/lite/micro/examples/fmnist/models/fmnist\
   --target_dir=/workspace/tflm/tflite-micro/tensorflow/lite/micro/examples/fmnist/models/\
`
"""
import math
import os
