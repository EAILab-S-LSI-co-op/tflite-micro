...
`
bazel-bin/tensorflow/lite/micro/examples/fmnist/train --save_tf_model --save_dir=/workspace/tflm/tflite-micro/tensorflow/lite/micro/examples/fmnist/models
`
"""
import math
import os
...
def main(_):
  ...
  model.export(f"{FLAGS.save_dir}/fmnist")
  model.save(f"{FLAGS.save_dir}/fmnist.h5")
